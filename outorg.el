...
;; `outorg-copy-edits-and-exit' (in the edit-buffer). If you want to insert
;; Org-mode source-code or example blocks in comment-sections, simply
;; outcomment them in the outorg-edit buffer before calling
...
(define-key outorg-edit-minor-mode-map "\C-c'"
  'outorg-copy-edits-and-exit)
